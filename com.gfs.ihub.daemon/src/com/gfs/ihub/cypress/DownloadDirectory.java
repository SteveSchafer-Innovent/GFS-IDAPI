...
public class DownloadDirectory implements java.io.Serializable {
	 ...
	 * Constructor
	 */
	public DownloadDirectory(String urlString, String volume, String username, String password) throws MalformedURLException,
	...
	public List<String> downloadFiles(final String downloadFolderName, final String osDestinationFolder) {
		
		List<String> messages = new ArrayList<String>();

		List<String> pdfFilesToProcess = getPDFInFolder(downloadFolderName);
		for (String iHubFileName : pdfFilesToProcess) {
			messages.add(downloadFile(iHubFileName, osDestinationFolder));
	 ...
	 */
	private List<String> getPDFInFolder(String folderName) {
	...
	private String downloadFile(final String iHubFileName, final String osDestinationFolder) {
		...
		try {
			...
			String dlFullFilePath = osDestinationFolder + fileName;
